...
const SearchEvents = ({ setCategory }) => {
		...
		<section id="search" className="container mx-auto px-40 my-10">
			<div className="grid grid-cols-3 max-w-4xl gap-5 items-end">
				<div>
					...
					<select name="categories" id="categories" className="appearance-none rounded-full ring-1 py-2 w-full max-h-10 ring-gray-400 focus:ring-2 focus:ring-gray-600 px-5 pr-9" onChange={handleChange}>
